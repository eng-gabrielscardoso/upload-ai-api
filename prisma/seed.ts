...
async function main() {
  ...
  await prisma.prompt.create({
    data: {
      title: "YouTube title",
      template:
        `Its role is generate three title for a video that will be uploaded to YouTube.

Below you will receive a transcription of this video, use this informations extracted from this transcription to generate the titles.
Below you wil receive a list of title as well, use this list as reference to generate the titles.

The title must be have a maximum length of 60 characters.
The titles must be 
